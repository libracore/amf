...
def create_address_from_lead(doc, method):
    ...
    # ...and so on
    address_link = address.append('links', {})
    address_link.link_doctype = doc.doctype
    address_link.link_name = doc.name
...
def create_contact_from_lead(doc, method):
    ...
    contact_link = contact.append('links', {})
    contact_link.is_primary_contact = True
    contact_link.link_doctype = doc.doctype
    contact_link.link_name = doc.name
