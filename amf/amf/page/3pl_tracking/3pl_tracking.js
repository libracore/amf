frappe.pages['3pl-tracking'].on_page_load = function(wrapper) {
    ...
    $(page.body).append('<div id="3pl-tracking-table"></div>');
    ...
    frappe.call({
        ...
        callback: function(response) {
            ...
            if (data && data.length > 0) {
                ...
                $('#3pl-tracking-table').append(table);
            } else {
                $('#3pl-tracking-table').html('<p>No tracking information found.</p>');
            }
        }
    });
};